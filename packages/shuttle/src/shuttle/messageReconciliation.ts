...
export class MessageReconciliation {
  ...
  private async *getAllCastMessagesByFidInBatchesOf(
    ...
    let result = await this.getAllCastMessagesByFid({
      pageSize,
      fid,
      startTimestamp,
      stopTimestamp,
    ...
    for (;;) {
      ...
      result = await this.getAllCastMessagesByFid({
        pageSize,
        pageToken,
        fid,
        startTimestamp,
  ...
  private async *getAllReactionMessagesByFidInBatchesOf(
    ...
    let result = await this.getAllReactionMessagesByFid({
      pageSize,
      fid,
      startTimestamp,
      stopTimestamp,
  ...
  private async *getAllLinkMessagesByFidInBatchesOf(
    ...
    let result = await this.getAllLinkMessagesByFid({
      pageSize,
      fid,
      startTimestamp,
      stopTimestamp,
    ...
    for (;;) {
      ...
      if (!pageToken?.length) break;
      result = await this.getAllLinkMessagesByFid({
        pageSize,
        pageToken,
        fid,
        startTimestamp,
    ...
    let deltaResult = await this.client.getLinkCompactStateMessageByFid({
      fid,
      pageSize,
    });
    for (;;) {
      ...
      if (!pageToken?.length) break;
      deltaResult = await this.client.getLinkCompactStateMessageByFid({
        pageSize,
        pageToken,
        fid,
      });
  ...
  private async *getAllVerificationMessagesByFidInBatchesOf(
    ...
    let result = await this.getAllVerificationMessagesByFid({
      pageSize,
      fid,
      startTimestamp,
      stopTimestamp,
  ...
  private async *getAllUserDataMessagesByFidInBatchesOf(
    ...
    let result = await this.getAllUserDataMessagesByFid({
      pageSize,
      fid,
      startTimestamp,
      stopTimestamp,
